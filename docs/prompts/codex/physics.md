...
- Verify core equations like rotational kinetic energy `E = 1/2 I ω^2` and torque `τ = I α`;
  use SI units (I in kg·m², ω in rad/s, α in rad/s², τ in N·m) and cite sources for any
  physical constants.

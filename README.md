...
## Related Projects
_Last updated: 2026-06-20 14:43 UTC; checks hourly_
...
- ✅ ⭐ 6 🔀 668 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
- ✅ ⭐ 3 🔀 2368 **[DSPACE](https://democratized.space)** @main – retro-futurist idle sim where quests teach real-world hobbies with NPC guides and offline-first progression ([repo](https://github.com/democratizedspace/dspace/tree/main))
...
- ❌ ([Build and publish GHCR image](https://github.com/futuroptimist/danielsmith.io/actions/runs/27859748474), [Resume artifacts](https://github.com/futuroptimist/danielsmith.io/actions/runs/27859748481), [Tests](https://github.com/futuroptimist/danielsmith.io/actions/runs/27859748486)) <!-- repo-status:failure-links --> ⭐ 0 🔀 474 **[danielsmith.io](https://github.com/futuroptimist/danielsmith.io)** – Vite + Three.js playground for an orthographic, keyboard-navigable portfolio scene

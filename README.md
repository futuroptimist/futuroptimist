...
## Related Projects
_Last updated: 2026-08-13 01:30 UTC; checks hourly_
...
- ✅ ⭐ 7 🔀 771 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
- ✅ ⭐ 4 🔀 2415 **[DSPACE](https://democratized.space)** – retro-futurist idle sim where quests teach real-world hobbies with NPC guides and offline-first progression ([repo](https://github.com/democratizedspace/dspace/tree/main))
...
- ✅ ⭐ 0 🔀 1543 **[sugarkube](https://github.com/futuroptimist/sugarkube)** – solar-powered k3s platform and cube art installation for off-grid Raspberry Pi clusters

...
## Related Projects
_Last updated: 2026-07-15 04:40 UTC; checks hourly_
...
- ✅ ⭐ 7 🔀 725 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
- ✅ ⭐ 4 🔀 2389 **[DSPACE](https://democratized.space)** @main – retro-futurist idle sim where quests teach real-world hobbies with NPC guides and offline-first progression ([repo](https://github.com/democratizedspace/dspace/tree/main))

...
Guidelines for AI tools live in [AGENTS.md](AGENTS.md). A reusable Codex prompt
lives in [docs/prompts/codex/automation.md](docs/prompts/codex/automation.md).
The automated tests run via GitHub Actions on each push and pull request and
currently reach **100%** coverage.

## Related Projects
_Last updated: 2025-08-26 23:02 UTC; checks hourly_

...
## Related Projects
_Last updated: 2026-07-22 07:33 UTC; checks hourly_
...
- ✅ ⭐ 7 🔀 737 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
...
- ✅ ⭐ 3 🔀 486 **[flywheel](https://github.com/futuroptimist/flywheel)** – GitHub template for solo builders who want linting, tests, docs, releases, and LLM-agent workflows in one starter kit
...
- ❌ ([Build and publish GHCR image](https://github.com/futuroptimist/jobbot3000/actions/runs/29891813072), [CI](https://github.com/futuroptimist/jobbot3000/actions/runs/29891812151)) <!-- repo-status:failure-links --> ⭐ 1 🔀 784 **[jobbot3000](https://github.com/futuroptimist/jobbot3000)** – self-hosted job-search copilot built on the same automation scaffold as this repo

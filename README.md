...
## Related Projects
_Last updated: 2026-08-03 15:37 UTC; checks hourly_
...
- ✅ ⭐ 7 🔀 756 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
...
- ✅ ⭐ 1 🔀 804 **[jobbot3000](https://github.com/futuroptimist/jobbot3000)** – self-hosted job-search copilot built on the same automation scaffold as this repo
...
- ❌ ([ci](https://github.com/futuroptimist/sugarkube/actions/runs/30788246778)) <!-- repo-status:failure-links --> ⭐ 0 🔀 1502 **[sugarkube](https://github.com/futuroptimist/sugarkube)** – solar-powered k3s platform and cube art installation for off-grid Raspberry Pi clusters

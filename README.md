...
## Related Projects
_Last updated: 2026-08-04 21:24 UTC; checks hourly_
...
- ✅ ⭐ 7 🔀 759 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
- ❌ ([Build and publish GHCR image](https://github.com/democratizedspace/dspace/actions/runs/30950157475)) <!-- repo-status:failure-links --> ⭐ 4 🔀 2405 **[DSPACE](https://democratized.space)** @main – retro-futurist idle sim where quests teach real-world hobbies with NPC guides and offline-first progression ([repo](https://github.com/democratizedspace/dspace/tree/main))
...
- ✅ ⭐ 1 🔀 811 **[jobbot3000](https://github.com/futuroptimist/jobbot3000)** – self-hosted job-search copilot built on the same automation scaffold as this repo
...
- ✅ ⭐ 0 🔀 1507 **[sugarkube](https://github.com/futuroptimist/sugarkube)** – solar-powered k3s platform and cube art installation for off-grid Raspberry Pi clusters

...
## Related Projects
_Last updated: 2026-08-03 22:58 UTC; checks hourly_
...
- ✅ ⭐ 7 🔀 757 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
- ❌ ([Build and publish GHCR image](https://github.com/democratizedspace/dspace/actions/runs/30848995383)) <!-- repo-status:failure-links --> ⭐ 4 🔀 2403 **[DSPACE](https://democratized.space)** @main – retro-futurist idle sim where quests teach real-world hobbies with NPC guides and offline-first progression ([repo](https://github.com/democratizedspace/dspace/tree/main))
...
- ✅ ⭐ 1 🔀 560 **[danielsmith.io](https://github.com/futuroptimist/danielsmith.io)** – Vite + Three.js playground for an orthographic, keyboard-navigable portfolio scene
...
- ✅ ⭐ 1 🔀 807 **[jobbot3000](https://github.com/futuroptimist/jobbot3000)** – self-hosted job-search copilot built on the same automation scaffold as this repo
...
- ❌ ([Update Repo Statuses](https://github.com/futuroptimist/futuroptimist/actions/runs/30856813051)) <!-- repo-status:failure-links --> ⭐ 0 🔀 337 **[futuroptimist](https://github.com/futuroptimist/futuroptimist)** – profile hub and production notebook for converting maker experiments into scripts, metadata, and reusable video workflows
- ✅ ⭐ 0 🔀 1505 **[sugarkube](https://github.com/futuroptimist/sugarkube)** – solar-powered k3s platform and cube art installation for off-grid Raspberry Pi clusters

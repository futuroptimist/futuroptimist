...
## Related Projects
_Last updated: 2026-07-21 18:09 UTC; checks hourly_
...
- ❌ ([CI](https://github.com/futuroptimist/token.place/actions/runs/29806044268)) <!-- repo-status:failure-links --> ⭐ 7 🔀 733 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
- ✅ ⭐ 4 🔀 2390 **[DSPACE](https://democratized.space)** @main – retro-futurist idle sim where quests teach real-world hobbies with NPC guides and offline-first progression ([repo](https://github.com/democratizedspace/dspace/tree/main))
- ✅ ⭐ 3 🔀 485 **[flywheel](https://github.com/futuroptimist/flywheel)** – GitHub template for solo builders who want linting, tests, docs, releases, and LLM-agent workflows in one starter kit
...
- ❌ ([Build and publish GHCR image](https://github.com/futuroptimist/jobbot3000/actions/runs/29697189263), [CI](https://github.com/futuroptimist/jobbot3000/actions/runs/29697189229)) <!-- repo-status:failure-links --> ⭐ 1 🔀 783 **[jobbot3000](https://github.com/futuroptimist/jobbot3000)** – self-hosted job-search copilot built on the same automation scaffold as this repo

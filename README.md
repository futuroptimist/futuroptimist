...
## Related Projects
_Last updated: 2026-06-28 07:16 UTC; checks hourly_
...
- ❌ ([CI](https://github.com/futuroptimist/token.place/actions/runs/28314449235)) <!-- repo-status:failure-links --> ⭐ 6 🔀 690 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
...
- ✅ ⭐ 0 🔀 514 **[danielsmith.io](https://github.com/futuroptimist/danielsmith.io)** – Vite + Three.js playground for an orthographic, keyboard-navigable portfolio scene

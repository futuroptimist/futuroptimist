...
## Related Projects
_Last updated: 2026-07-21 10:15 UTC; checks hourly_
...
- ❌ ([CI](https://github.com/futuroptimist/token.place/actions/runs/29806044268), [Claude PR Assistant](https://github.com/futuroptimist/token.place/actions/runs/29807996176)) <!-- repo-status:failure-links --> ⭐ 7 🔀 733 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))

...
## Related Projects
_Last updated: 2026-06-28 03:02 UTC; checks hourly_
...
- ❌ ([link-check](https://github.com/democratizedspace/dspace/actions/runs/28308086637)) <!-- repo-status:failure-links --> ⭐ 3 🔀 2386 **[DSPACE](https://democratized.space)** @main – retro-futurist idle sim where quests teach real-world hobbies with NPC guides and offline-first progression ([repo](https://github.com/democratizedspace/dspace/tree/main))
...
- ✅ ⭐ 0 🔀 513 **[danielsmith.io](https://github.com/futuroptimist/danielsmith.io)** – Vite + Three.js playground for an orthographic, keyboard-navigable portfolio scene

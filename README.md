...
## Related Projects
_Last updated: 2026-07-12 07:59 UTC; checks hourly_
...
- ✅ ⭐ 7 🔀 718 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
...
- ❌ ([Validate and publish Helm chart](https://github.com/futuroptimist/jobbot3000/actions/runs/29176941927)) <!-- repo-status:failure-links --> ⭐ 1 🔀 777 **[jobbot3000](https://github.com/futuroptimist/jobbot3000)** – self-hosted job-search copilot built on the same automation scaffold as this repo
...
- ✅ ⭐ 0 🔀 1463 **[sugarkube](https://github.com/futuroptimist/sugarkube)** – solar-powered k3s platform and cube art installation for off-grid Raspberry Pi clusters

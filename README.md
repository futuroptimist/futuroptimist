...
## Related Projects
_Last updated: 2026-08-31 07:10 UTC; checks hourly_
...
- ✅ ⭐ 7 🔀 792 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
...
- ❌ ([Link Check](https://github.com/futuroptimist/flywheel/actions/runs/33333613097)) <!-- repo-status:failure-links --> ⭐ 3 🔀 491 **[flywheel](https://github.com/futuroptimist/flywheel)** – GitHub template for solo builders who want linting, tests, docs, releases, and LLM-agent workflows in one starter kit
...
- ✅ ⭐ 1 🔀 1584 **[sugarkube](https://github.com/futuroptimist/sugarkube)** – solar-powered k3s platform and cube art installation for off-grid Raspberry Pi clusters

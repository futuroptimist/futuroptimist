...
## Related Projects
_Last updated: 2026-09-04 06:06 UTC; checks hourly_
...
- ❌ ([CI](https://github.com/futuroptimist/token.place/actions/runs/33841529341)) <!-- repo-status:failure-links --> ⭐ 7 🔀 802 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
...
- ✅ ⭐ 1 🔀 1588 **[sugarkube](https://github.com/futuroptimist/sugarkube)** – solar-powered k3s platform and cube art installation for off-grid Raspberry Pi clusters

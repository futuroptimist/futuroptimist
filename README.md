...
## Related Projects
_Last updated: 2026-06-23 00:32 UTC; checks hourly_
...
- ✅ ⭐ 6 🔀 678 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
- ✅ ⭐ 3 🔀 2376 **[DSPACE](https://democratized.space)** @main – retro-futurist idle sim where quests teach real-world hobbies with NPC guides and offline-first progression ([repo](https://github.com/democratizedspace/dspace/tree/main))
...
- ✅ ⭐ 0 🔀 491 **[danielsmith.io](https://github.com/futuroptimist/danielsmith.io)** – Vite + Three.js playground for an orthographic, keyboard-navigable portfolio scene
...
- ❌ ([Close my open PRs](https://github.com/futuroptimist/pr-reaper/actions/runs/27985922104)) <!-- repo-status:failure-links --> ⭐ 0 🔀 48 **[pr-reaper](https://github.com/futuroptimist/pr-reaper)** – GitHub workflow for safely closing stale pull requests in bulk with dry-run support

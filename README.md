...
## Related Projects
_Last updated: 2026-07-06 14:59 UTC; checks hourly_
...
- ❌ ([Claude PR Assistant](https://github.com/futuroptimist/token.place/actions/runs/28773314449)) <!-- repo-status:failure-links --> ⭐ 6 🔀 707 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
...
- ✅ ⭐ 0 🔀 530 **[danielsmith.io](https://github.com/futuroptimist/danielsmith.io)** – Vite + Three.js playground for an orthographic, keyboard-navigable portfolio scene
...
- ✅ ⭐ 0 🔀 762 **[jobbot3000](https://github.com/futuroptimist/jobbot3000)** – self-hosted job-search copilot built on the same automation scaffold as this repo
...
- ✅ ⭐ 0 🔀 1439 **[sugarkube](https://github.com/futuroptimist/sugarkube)** – solar-powered k3s platform and cube art installation for off-grid Raspberry Pi clusters

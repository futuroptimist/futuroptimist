...
## Related Projects
_Last updated: 2026-06-21 17:29 UTC; checks hourly_
...
- ✅ ⭐ 6 🔀 674 **[token.place](https://token.place)** – peer-to-peer generative AI network for people sharing idle compute through ephemeral, encrypted tokens ([repo](https://github.com/futuroptimist/token.place))
- ✅ ⭐ 3 🔀 2372 **[DSPACE](https://democratized.space)** @main – retro-futurist idle sim where quests teach real-world hobbies with NPC guides and offline-first progression ([repo](https://github.com/democratizedspace/dspace/tree/main))
...
- ✅ ⭐ 0 🔀 482 **[danielsmith.io](https://github.com/futuroptimist/danielsmith.io)** – Vite + Three.js playground for an orthographic, keyboard-navigable portfolio scene

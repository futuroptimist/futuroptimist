...
## Related Projects
_Last updated: 2026-08-05 23:20 UTC; checks hourly_
...
- ❌ ([Build and publish GHCR image](https://github.com/democratizedspace/dspace/actions/runs/31054063757)) <!-- repo-status:failure-links --> ⭐ 4 🔀 2409 **[DSPACE](https://democratized.space)** @main – retro-futurist idle sim where quests teach real-world hobbies with NPC guides and offline-first progression ([repo](https://github.com/democratizedspace/dspace/tree/main))

...
It classifies selects as images, video, or audio and tags folder entries as
`directory_select` (see `tests/test_report_funnel.py::test_build_manifest_with_selects`
